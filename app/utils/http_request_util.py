...
#  todo: fix this up
def get_client_ip():
    if config.ServerLocation.traffic_comming_through_cloudflare and request.headers.get("CF-Connecting-IP"):
        return request.headers.get("CF-Connecting-IP")
    if config.ServerLocation.traffic_comming_through_proxy:
        try:
